...
setInterval(function() {
	var timespan = countdown(new Date("06/17/2020"), new Date());
	var timespan1 = countdown(new Date("06/17/2019"), new Date());
    var div = document.getElementById('time');
    div.innerHTML = "<div><span>Años</span>" + timespan1.years + "</div>" + "<div><span>Meses</span>" + timespan1.months + "</div>" + "<div><span>Dias</span>" + timespan1.days + "</div>" + "<div><span>Hours</span>" + timespan1.hours + "</div>" + "<div><span>Minutos</span>" + timespan1.minutes + "</div>" + "<div><span>Segundos</span>" + timespan1.seconds + "</div><br>"+ "<div><span>Años</span>" + timespan.years + "</div>" + "<div><span>Meses</span>" + timespan.months + "</div>" + "<div><span>Dias</span>" + timespan.days + "</div>" + "<div><span>Hours</span>" + timespan.hours + "</div>" + "<div><span>Minutos</span>" + timespan.minutes + "</div>" + "<div><span>Segundos</span>" + timespan.seconds + "</div><br>"
}, 1000);
